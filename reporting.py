...
from bechunt.config import CONFIG, TOOL_VERSION, V7_PARSER_VERSION
from bechunt.models import EmailRecord, CampaignInfo, AttackTimelineEvent
from bechunt.utils import date_sort_key, to_utc_fields, clean_text, parse_date
from bechunt.scoring import classify_attack_stage, build_evidence_graph
...
def print_run_manifest(manifest):
    ...
    print("=" * 80)
    c = manifest["corpus"]
    print(f"Tool: bec_hunt {manifest['tool_version']} (parser {manifest['parser_version']})")
