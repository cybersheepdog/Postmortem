...
function render(){dashboard();execSummary();initialPanel();entryPointPanel();sessionsPanel();exposurePanel();remediationPanel();notifyPanel();driftPanel();narrativePanel();verdict();timeline();graph();networkGraph();topDomains();campaigns();candidates();toggleEdges();}
